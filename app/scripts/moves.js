...
app.usamoves = [
  ...
  },
  {
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'Also called a guillotine leg drop, this diving attack sees a wrestler jump forward from a raised platform (i.e. top turnbuckle, the ring apron, etc.) landing the bottom side of his/her leg across an opponent (usually on the throat or face). '
  },
  {
    name: 'Diving leg drop bulldog',
    reqStrength: 1,
    reqSpeed: 5,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'This is a diving version of the leg drop bulldog, that sees the wrestler springboarding off one of the ropes or jumping from the top turnbuckle and dropping their leg across the back of the head of an opponent who is leaning forward. '
  },
  {
    name: 'Moonsault leg drop',
    reqStrength: 1,
    reqSpeed: 5,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'This variation sees the wrestler perform a top turnbuckle moonsault but instead of landing on the opponent in a splash position the wrestler would continue the rotation to drive his leg across an opponent who is lying on the ground. '
  },
  {
    name: 'Somersault leg drop',
    reqStrength: 1,
    reqSpeed: 6,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'The wrestler, standing on an elevated position, jumps, flips forward and lands his leg on the opponent lying beneath him. This move was made famous by Booker T, who called it the Harlem Hangover. This move can also be performed from a position that is not elevated, although this variation is rarer. Jeff Hardy is known for performing the non-elevated variation.'
  },
  {
    name: 'Diving shoulder block/Diving spear',
    reqStrength: 2,
    reqSpeed: 2,
    reqOrgasm: 0,
    reqSubmission: 0,
  ...
  },
  {
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'With the wrestler standing over the top turnbuckle or the top ropes, he jumps off and slightly twists so he\'s elevated in the midair facing away from the opponent, with one of his sides facing the mat. From this point, the wrestler delivers a kick with the back of his leg. '
  },
  {
    name: 'Diving stomp/Moonsault double foot stomp/Mushroom stomp',
    reqStrength: 1,
    reqSpeed: 2,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'The wrestler jumps down from a raised platform onto an opponent, dropping his foot onto any part of an opponent\'s body. A variation known as a diving double foot stomp is when a wrestler jumps down from a raised platform on an opponent driving both his feet into anywhere on the opponent\'s body, usually the chest. \n Moonsault double foot stomp: \n This variation sees the wrestler perform a backflip moonsault, but instead of landing on a fallen opponent in the splash position, the wrestler continues the rotation so that he/she drives both feet into the opponent. \n Mushroom stomp: \n While situated on the middle rope of a turnbuckle, a wrestler jumps over a charging opponent and drives his feet into the opponent\'s back in order to push him into the turnbuckle or the ground with greater force, before landing on his feet. '
  },
  {
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'Also known as Diving clothesline, is a move in which a wrestler will jump from an elevated position and perform a clothesline to a standing opponent. A version of this move, called a flying lariat, involves the wrestler wrapping his arm around the opponent\'s head.'
  },
  {
    name: 'Flying neckbreaker/blockbuster',
    reqStrength: 1,
    reqSpeed: 8,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'A neckbreaker in which the attacking wrestler jumps from a raised platform (usually the second turnbuckle) and grabs an opponent\'s neck while in midair, thereby taking them down with a neckbreaker. \n Blockbuster \n In this variation of a flying neckbreaker, the wrestler performing the maneuver will climb to the top rope and wait for his opponent to face him. Once the opponent does, the wrestler jumps and performs a somersault in mid air. While somersaulting, the wrestler will catch the opponent\'s head and neck with his hands and perform a falling neckbreaker as he lands. '
  },
  {
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'A move in which the wrestler will jump from an elevated position (usually the top turnbuckle) and strike a standing opponent with spinning heel kick in mid-air. '
  },
  {
    name: 'Frankensteiner/Reverse Frakensteiner',
    reqStrength: 1,
    reqSpeed: 9,
    reqOrgasm: 0,
    reqSubmission: 0,
  ...
  },
  {
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'Executed when a wrestler jumps from a raised platform (usually the top turnbuckle), and hits a standing opponent with a thrust kick in mid-air. '
  },
  {
    name: 'Moonsault',
    reqStrength: 1,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'A move in which a wrestler executes a backflip and lands on an opponent.A basic moonsault is generally attempted from the top turnbuckle, though myriad variations exist.'
  },
  {
    name: 'Corkscrew moonsault',
    reqStrength: 1,
    reqSpeed: 7,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'A move similar to the moonsault but twists a 130° spin a and lands on a grounded or standing opponent, basically used as a standing move but can be executed from the top turnbuckle. '
  },
  {
    name: 'Senton(All variations)',
    reqStrength: 1,
    reqSpeed: 5,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'A senton splash (also known as Back Splash) is similar to a normal splash. Instead of impacting stomach first, the wrestler lands back first across the opponent. \n Sentons that exist: Senton, 630º Seton, Moonsault Senton, Imploding senton bomb, seated senton, molly-go-round, senton bomb, high angle senton bomb. '
  },
  {
    name: 'Shiranui',
    reqStrength: 1,
  ...
  },
  {
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'Moves: Shooting star leg drop,Shooting star elbow drop,Shooting star DDT,Shooting star senton,Corkscrew shooting star press,Springboard Shooting Star Press. '
  },
  {
    name: 'Splash',
    reqStrength: 1,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'The basic splash, which is also known as a body press, involves a wrestler jumping forward from a raised platform (usually the top turnbuckle) and landing stomach first across an opponent lying on the ground below.'
  },
  {
    name: 'Splash variations',
    reqStrength: 1,
    reqSpeed: 6,
    reqOrgasm: 0,
    reqSubmission: 0,
    ...
    holdDuration: 0,
    category: 'highflying',
    decription: 'Moves: 450º splash, Phoenix splash, imploding 450º splash, corner slingshot splash, frog splash.'
  },
  {
    name: 'Sunset flip',
    reqStrength: 1,
